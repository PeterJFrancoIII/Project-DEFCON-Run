...
void main() {
  group('Jobs v2 Integration Tests', () {
    ...
    group('Worker Flow', () {
      test('worker can login, browse, and apply for jobs', () async {
      ...
      test('worker can view applied jobs', () async {
        mockApi.setupWorkerUser();
      ...
      test('worker can upgrade to employer', () async {
        mockApi.setupWorkerUser();
      ...
      test('worker can update notification settings', () async {
        mockApi.setupWorkerUser();
    ...
    group('Employer Flow', () {
      test('verified employer can post jobs', () async {
      ...
      test('employer can view their listings', () async {
      ...
      test('unverified employer has limited access', () async {
    ...
    group('Authentication Flow', () {
      ...
      test('registration creates worker account', () async {
    ...
    group('Search & Filter', () {
      test('search returns all listings without filter', () async {
      ...
      test('search with non-existent category returns empty', () async {
    ...
    group('Application Flow', () {
      test('applying to job adds to applications list', () async {
        mockApi.setupWorkerUser();
