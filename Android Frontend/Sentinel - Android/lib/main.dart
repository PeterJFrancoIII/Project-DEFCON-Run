            ...
            children: [
              Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      boxShadow: const [
                        BoxShadow(color: Color(0x33FFEB3B), blurRadius: 20)
                      ]),
              ...
              SizedBox(
                  ...
                  child: CupertinoSegmentedControl<String>(
                    children: const {
                      ...
                      "th": Padding(
                          padding: EdgeInsets.all(8), child: Text("ภาษาไทย")),
                      "km": Padding(
                          padding: EdgeInsets.all(8), child: Text("ភាសាខ្មែរ"))
                    },
              ...
              SizedBox(
                  ...
                  child: CupertinoSegmentedControl<String>(
                    children: const {
                      "TH": Padding(
                          padding: EdgeInsets.all(8), child: Text("THAILAND")),
                      "KH": Padding(
                          padding: EdgeInsets.all(8), child: Text("CAMBODIA"))
                    },
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(children: [
      FlutterMap(
        ...
        options: MapOptions(initialCenter: userPos, initialZoom: 9.0),
        children: [
          TileLayer(
